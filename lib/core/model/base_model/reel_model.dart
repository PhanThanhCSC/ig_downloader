...
ReelModel welcomeFromJson(String str) => ReelModel.fromJson(json.decode(str));

String welcomeToJson(ReelModel data) => json.encode(data.toJson());
...
class ShortcodeMedia {
  ...
  factory ShortcodeMedia.fromJson(Map<String, dynamic> json) => ShortcodeMedia(
        ...
        clipsMusicAttributionInfo: ClipsMusicAttributionInfo.fromJson(
...
class EdgeOwnerToTimelineMedia {
  ...
  factory EdgeOwnerToTimelineMedia.fromJson(Map<String, dynamic> json) =>
      EdgeOwnerToTimelineMedia(
        count: json["count"],
        edges: List<EdgeOwnerToTimelineMediaEdge>.from(
            json["edges"].map((x) => EdgeOwnerToTimelineMediaEdge.fromJson(x))),
      );
...
class StickyNode {
  ...
  factory StickyNode.fromJson(Map<String, dynamic> json) => StickyNode(
        ...
        shortcode: json["shortcode"],
        edgeMediaPreviewLike:
            EdgeFollowedByClass.fromJson(json["edge_media_preview_like"]),
        edgeMediaPreviewComment:
            EdgeFollowedByClass.fromJson(json["edge_media_preview_comment"]),
        thumbnailSrc: json["thumbnail_src"],
